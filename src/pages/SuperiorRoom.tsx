...
const RoomCard = ({ title, description, details, images, availableAmenities, categoriesToShow }) => {
  ...
  const amenityLabels = {
    ...
    list52:t("economy.list52"),
    list53:t("economy.list53"),
    list54:t("economy.list54"),
    list55:t("economy.list55"),
    list56:t("economy.list56"),
    list57:t("economy.list57"),
    list58:t("economy.list58"),
    list59:t("economy.list59")
  };

  const allAmenityGroups = [
    { title: t('economy.c1'), keys: ['list7','list8','list9','list10','list11'] },
    { title: t('economy.c2'), keys: ['list12','list13','list51',"list52"] },
    { title: t('economy.c3'), keys: ['list1','list2','list3','list4','list5','list14','list15','list16','list17','list18','list19','list20','list21','list23','list25','list26','list28','list29','list30','list31','list33','list34','list35','list36','list39','list40','list41','list42','list43','list44','list53','list54','list55','list56','list57','list58','list59'] },
    { title: t('economy.c4'), keys: ['list1','list2','list3','list4','list5','list22'] },
  ];
...
const RoomCardPage = () => {
  ...
  const gardenviewapartment = ['list2','list4','list7','list8','list9','list10','list11','list12','list13','list14','list15','list16','list17','list20','list21','list22','list23','list24','list26','list27','list29','list31','list33','list34','list35','list36','list39','list40','list41','list43','list44'];
  const gardenAmenities = ['list1','list2','list4','list7','list8','list9','list10','list11','list14','list15','list16','list17','list18','list19','list20','list21','list23','list26','list29','list31','list33','list34','list35','list36','list39','list40','list41','list43','list44','list51'];
  const standardAmenities = ['list1','list2','list4','list6','list7','list8','list9','list10','list11','list14','list15','list16','list17','list19','list20','list21','list24','list26','list28','list29','list30','list34','list35','list36','list39','list40','list41','list43','list44',"list52"];
  const balconyAmenities = ['list1','list2','list4','list6','list7','list8','list9','list11','list14','list15','list16','list17','list19','list20','list21','list24','list26','list28','list29','list30','list34','list35','list36','list39','list40','list41','list43','list44',"list52"];
  const familyAmenities = ['list1','list2','list7','list8','list9','list10','list11','list14','list15','list16','list20','list21','list23','list26','list27','list28','list29','list34','list35','list36','list39','list40','list41','list43','list44','list52'];
  const apartmentpool= ['list1','list2','list7','list8','list9','list10','list11','list14','list15','list16','list20','list21','list23','list26','list27','list28','list29','list34','list35','list36','list39','list40','list41','list43','list44','list52']
  const suite =['list1','list2','list4','list7','list8','list9','list10','list11','list12','list13','list14','list15','list16','list17','list18','list20','list21','list22','list23','list24','list25','list26','list27','list28','list29','list33','list34','list35','list36','list37','list39','list40','list41','list42','list43','list44']
  const queensuite= ['list7','list8','list9','list10','list11','list14','list15','list16','list20','list21','list22','list23','list26','list27','list28','list29','list31','list34','list35','list36','list39','list40','list41','list43','list44','list52'] 
  const superior1=['list3','list6','list10','list27','list28','list34','list36','list37','list52','list53','list54','list55','list56','list57','list58','list59']
  const suitepool=['list1','list2','list4','list7','list8','list9','list10','list11','list14','list15','list16','list17','list18','list20','list21','list22','list23','list24','list25',,'list26','list27','list28','list29','list31','list33','list34','list35','list36','list37','list39','list40','list41','list43','list44','list51','list52']
  return (
    <div className="pt-32 bg-blue-50 min-h-screen pb-20">
      <Header />
      <h1 className="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-16 px-4">{t('economy.title15')}</h1>
      <div className="grid gap-16 place-items-center px-4 md:px-12">
        <RoomCard
          title={t('economy.title11')}
          description={t('economy.size1')}
          details={<>{t('economy.p2')}<br /><br />{t('economy.p8')} <br /> <br />{t('economy.d7')}</>}
          images={['/public/apartment/bed1.png', '/public/apartment/bed2.png', '/public/apartment/kouzina.png', '/public/apartment/mpanio.png']}
          availableAmenities={gardenviewapartment}
          categoriesToShow={[0, 1, 2, 3]}
        />
        <RoomCard
          title={t('economy.title3')}
          description={t('economy.size2')}
          details={<>{t('economy.p2')}<br /><br />{t('economy.p8')}<br /><br />{t('economy.d7')}</>}
          images={['/public/juniorsuit/bed1.png','/public/juniorsuit/bed2.png','/public/juniorsuit/bed3.png','/public/juniorsuit/saloni.png','/public/juniorsuit/bed4.png']}
          availableAmenities={gardenAmenities}
          categoriesToShow={[0, 1, 2, 3]}
        />
        <RoomCard
          title={t('economy.title6')}
          description={t('economy.size1')}
          details={<>{t('economy.p2')}<br /><br />{t('economy.p3')}<br /><br />{t('economy.paragraph')}</>}
          images={['/public/loft_pool/kouzina.png', '/public/loft_pool/bed1.png', '/public/loft_pool/general.png', '/public/loft_pool/bed2.png', '/public/loft_pool/ntouz.png']}
          availableAmenities={standardAmenities}
          categoriesToShow={[0, 1, 2, 3]}
        />
        <RoomCard
          title={t('economy.title6')}
          description={t('economy.size1')}
          details={<>{t('economy.p2')}<br /><br />{t('economy.p3')}<br /><br />{t('economy.paragraph')}</>}
          images={['/public/loft_pool2/bed1.png', '/public/loft_pool2/bed2.png', '/public/loft_pool2/mpalkoni.png', '/public/loft_pool2/mpanio.png', '/public/loft_pool2/mpanio2.png']}
          availableAmenities={balconyAmenities}
          categoriesToShow={[0, 1, 2, 3]}
        />
        ...
        <RoomCard
          title={t('economy.title8')}
          description={t('economy.size5')}
          details={<>{t('economy.d6')}<br /><br />{t('economy.p3')}<br /><br />{t('economy.paragraph')}</>}
          images={['/public/king_bed1.png', '/public/king_bed2.png', '/public/king_bed3.png', '/public/king_pool.png', '/public/king_ρουχα.png']}
          availableAmenities={familyAmenities}
          categoriesToShow={[0, 1, 2, 3]}
        />
        ...
        <RoomCard
          title={t('economy.title5')}
          description={t('economy.size3')}
          details={<>{t('economy.d6')} <br /><br />{t('economy.p3')}<br /><br />{t('economy.paragraph')}</>}
          images={['/public/appool_bed1.png', '/public/appool_bed2.png', '/public/appool_bed3.png', ]}
          availableAmenities={apartmentpool}
          categoriesToShow={[0, 1, 2,]}
        />

        <RoomCard
          title={t('economy.title2')}
          description={t('economy.size1')}
          details={<>{t('economy.d2')} <br /><br />{t('economy.d3')}<br /><br />{t('economy.p3')} <br/> <br/> {t('')}</>}
          images={['/public/suitebal_bed1.png', '/public/suitebal_bed2.png', '/public/suitebal_bed3.png', '/public/suitebal_bed4.png']}
          availableAmenities={suite}
          categoriesToShow={[0, 1, 2, 3]}
        />

        <RoomCard
          title={t('economy.title9')}
          description={t('economy.size6')}
          details={<>{t('economy.d6')} <br /><br />{t('economy.p3')} <br/> <br/> {t('')}</>}
          images={['/public/king_size/bed1.png', '/public/king_size/bed2.png', '/public/king_size/ntoulapa.png', ]}
          availableAmenities={queensuite}
          categoriesToShow={[0, 1, 2, ]}
        />

        <RoomCard
          title={t('economy.title10')}
          description={t('economy.size6')}
          details={<>{t('economy.d6')} <br /><br />{t('economy.p3')} <br/> <br/> {t('')}</>}
          images={['/public/superior_bed1.png', '/public/superior_bed2.png', '/public/superior_bed3.png','/public/superior_bath.png', ]}
          availableAmenities={superior1}
          categoriesToShow={[0, 1, 2, 3]}
        />
        ...
        <RoomCard
          title={t('economy.title4')}
          description={t('economy.size6')}
          details={<>{t('economy.d6')} <br /><br />{t('economy.p3')} <br/> <br/> {t('')}</>}
          images={['/public/suitepool_bath.png', '/public/suitepool_bed1.png', '/public/suitepool_bed2.png','/public/suitepool_kitch.png' ]}
          availableAmenities={suitepool}
          categoriesToShow={[0, 1, 2, 3]}
        />
