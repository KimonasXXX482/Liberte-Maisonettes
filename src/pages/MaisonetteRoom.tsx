...
const RoomCardPage = () => {
  ...
  return (
    <div className="pt-32 bg-blue-50 min-h-screen pb-20">
      ...
      <h1 className="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-16 px-4">{t('economy.title55')}</h1>
      <div className="grid gap-16 place-items-center px-4 md:px-12">
        
        <RoomCard
          title={t('economy.title')}
          description={t('economy.p1')}
          details={<>{t('economy.p2')}<br /><br />{t('economy.p3')}<br /><br />{t('economy.paragraph')}</>}
          images={['/public/mezoneta/kanapes_gwnia.png', '/public/mezoneta/kanapes.png', '/public/mezoneta/kouzina.png', '/public/mezoneta/panw_orofos.png', ]}
        ...
        <RoomCard
          ...
          description={t('economy.p1')}
          details={<>{t('economy.p2')}<br /><br />{t('economy.p3')}<br /><br />{t('economy.paragraph')}</>}
          images={['/public/mezoneta2/kanapedes.png','/public/mezoneta2/kouzina.png','/public/mezoneta2/bed1.png']}
